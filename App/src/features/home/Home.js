...
import { AppRegistry, Text, View, Image, BackAndroid, ScrollView } from 'react-native';
        ...
        return (
            <ScrollView>
                <List>
                    ...
                    >
                        <IconIO name="ios-paper" style={ styles.iconStyle }/>
                    ...
                    <ListItem button onPress={this.menu.Calendar}>
                        <IconIO name="ios-calendar" style={ styles.iconStyle }/>
                    ...
                    <ListItem button onPress={this.menu.Marks}>
                        <IconIO name="md-bookmarks" style={ styles.iconStyle }/>
                    ...
                    <ListItem button onPress={this.menu.Logout}>
                        <IconIO name="md-log-out" style={ styles.logoutStyle }/>
